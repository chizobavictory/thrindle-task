...
function welcomeEmail(firstname, otp, token) {
                    ...
                    <tbody>
                      ...
                      <tr style="padding: 0px">
                        ...
                        >
                         ...
                         <br>
                         <br>
                         <a href="${config_1.config.FRONTEND_BASE_URL}/verify/?token=${token}">click here to verify</a> or copy this ${config_1.config.FRONTEND_BASE_URL}/verify/?token=${token} link and paste in your browser.
                         <br>
                          Thank you. <br /><br />
                        </td>
                      </tr>
